...
public class PhaseManager {
    ...
    public static final List<Phase> phases = List.of(
            new Phase("Plains", 50, BossEvent.BossBarColor.GREEN, ChatFormatting.GREEN,List.of(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.DIRT_PATH, Blocks.PUMPKIN), List.of(EntityType.SHEEP, EntityType.CHICKEN, EntityType.PIG, EntityType.COW, EntityType.HORSE), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/plains")), true),
            new Phase("Forest", 80, BossEvent.BossBarColor.GREEN, ChatFormatting.DARK_GREEN, List.of(Blocks.OAK_LOG, Blocks.OAK_LEAVES, Blocks.BEE_NEST, Blocks.BIRCH_LOG), List.of(EntityType.WOLF, EntityType.BEE), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/forest")), false),
            new Phase("Beach", 70, BossEvent.BossBarColor.YELLOW, ChatFormatting.YELLOW,List.of(Blocks.SAND, Blocks.SANDSTONE, Blocks.GRAVEL, Blocks.CLAY), List.of(EntityType.TURTLE), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/beach")), false),
            new Phase("Badlands", 50, BossEvent.BossBarColor.YELLOW, ChatFormatting.GOLD,List.of(Blocks.RED_SAND, Blocks.RED_SANDSTONE, Blocks.TERRACOTTA, Blocks.CACTUS, Blocks.RED_TERRACOTTA, Blocks.ORANGE_TERRACOTTA, Blocks.YELLOW_TERRACOTTA, Blocks.BROWN_TERRACOTTA, Blocks.WHITE_TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA, Blocks.GOLD_ORE), List.of(EntityType.HUSK), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/badlands")), false),
            ...
            new Phase("Dark Forest", 80, BossEvent.BossBarColor.RED, ChatFormatting.RED,List.of(Blocks.DARK_OAK_LOG, Blocks.DARK_OAK_LEAVES, Blocks.RED_MUSHROOM_BLOCK, Blocks.BROWN_MUSHROOM_BLOCK), List.of(), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/darkoak")), false),
            new Phase("Caves", 200,BossEvent.BossBarColor.WHITE, ChatFormatting.GRAY,List.of(Blocks.STONE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.GRANITE, Blocks.COAL_ORE, Blocks.IRON_ORE, Blocks.REDSTONE_ORE, Blocks.DIAMOND_ORE, Blocks.COPPER_ORE, Blocks.LAPIS_ORE), List.of(EntityType.SKELETON, EntityType.ZOMBIE, EntityType.SPIDER), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/caves")), false),
            ...
            new Phase("Deep dark", 200,BossEvent.BossBarColor.BLUE, ChatFormatting.DARK_AQUA,List.of(Blocks.SCULK, Blocks.SCULK_SENSOR, Blocks.SCULK_CATALYST, Blocks.SCULK_SHRIEKER), List.of(EntityType.WARDEN), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/deepdark")), false),
            new Phase("Nether wastes", 300,BossEvent.BossBarColor.RED, ChatFormatting.DARK_RED,List.of(Blocks.NETHERRACK, Blocks.SOUL_SAND, Blocks.GLOWSTONE, Blocks.NETHER_GOLD_ORE, Blocks.NETHER_QUARTZ_ORE, Blocks.MAGMA_BLOCK, Blocks.BLACKSTONE), List.of(EntityType.PIGLIN, EntityType.STRIDER, EntityType.ZOMBIFIED_PIGLIN), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/netherwastes")), false),
            ...
            new Phase("Soul sand valley", 90,BossEvent.BossBarColor.RED, ChatFormatting.RED,List.of(Blocks.NETHERRACK, Blocks.SOUL_SAND), List.of(EntityType.WITHER_SKELETON), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/soulsandvalley")), false),
            ...
            new Phase("The End", 200,BossEvent.BossBarColor.PURPLE, ChatFormatting.LIGHT_PURPLE,List.of(Blocks.END_STONE, Blocks.CHORUS_FLOWER, Blocks.OBSIDIAN), List.of(EntityType.ENDERMAN), List.of(Identifier.fromNamespaceAndPath("moreworldpresets", "chests/end")), false)
